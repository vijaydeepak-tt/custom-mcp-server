...
def add_note(message: str) -> str:
    ...
    Args:
        message(str): The note content that to be added.

    Returns:
        str: Confirmation message indication the note was saved.
    """
    ensure_file()
...
def read_notes() -> str:
    ...
    return content or "No Notes added."
...
def get_latest_note() -> str:
    ...
    with open(NOTES_FILE, "r") as f:
        lines = f.readlines()
    return lines[-1] if lines else "No Notes added."
...
def note_summary_prompt() -> str:
    ...
    return f"Summarize the content notes {content}"